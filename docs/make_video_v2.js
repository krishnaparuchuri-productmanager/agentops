...
const SLIDES = [
  ...
  {
    // LangSmith slide 1: Projects list — real UI screenshot
    type: 'image', img: 'langsmith-projects.png', dur: 9,
    title: 'LangSmith APAC — Tracing Projects',
    annotation: [
      'Live Observability',
      '',
      'Both production systems',
      'push traces to LangSmith',
      'APAC after every call.',
      '',
      'medassist',
      '  2 traces · 0% error',
      '  P50 2.26s · 688 tokens',
      '',
      'gmp-deviation-review',
      '  1 trace · 0% error',
      '  P50 0.83s · 1,993 tokens',
      '',
      'PHI stripped before',
      'every trace push.',
    ],
  ...
  {
    // LangSmith slide 2: Trace detail — real UI screenshot
    type: 'image', img: 'langsmith-trace-detail.png', dur: 10,
    title: 'LangSmith APAC — Trace Detail',
    annotation: [
      ...
      '  3. ctx.waitUntil() fires',
      '     background push',
      '',
      'Input logged:',
      '  task_type: scheduling',
      '  user_input: [ANONYMISED]',
      '',
